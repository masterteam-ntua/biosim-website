---
layout: person
title: "Kalliopi Dalakleidi"
name_el: "Καλλιόπη Δαλακλείδη"
role: "Collaborator"
role_el: "Συνεργάτιδα"
...
content_el: |
  ...
  **Ερευνητικά Ενδιαφέροντα**
  Tεχνολογίες σημασιολογικού ιστού, οι αλγόριθμοι μηχανικής και βαθιάς μάθησης, οι τεχνικές όρασης υπολογιστών και τα υπολογιστικά συστήματα υποστήριξης ιατρικών αποφάσεων για τη διαχείριση χρόνιων ασθενειών
