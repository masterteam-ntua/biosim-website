  ...
  <div class="two-grid">
    <article class="article-card" data-aos="fade-up">
      ...
      {% if site.lang == 'el' %}
        ...
        <p>Γραφείο Καθηγήτριας Κωνσταντίνας Νικήτα: Γραφείο 1.1.17<br>Γραφείο Υποψηφίων Διδακτόρων και Μεταδιδακτορικών ερευνητών: Γραφείο 1.1.2<br>Γραφείο Υποψηφίων Διδακτόρων και Μεταδιδακτορικών ερευνητών: Γραφείο 2.1.26</p>
      ...
      {% else %}
        ...
        <p>Professor's Nikita Office: Room 1.1.17<br>PhD & Post Doc Office: Room 1.1.2<br>PhD & Post Doc Office: Room 2.1.26</p>
