...
We are thrilled to invite you for an open lecture at the National Technical University of Athens (NTUA), featuring distinguished guest speaker [Professor Manolis Kellis](http://mit.edu/manoli) from the Massachusetts Institute of Technology (MIT). This event is a part of the "Biodesign Fundamentals" course offered under the [Master of Science "Translational Engineering in Health and Medicine”](https://masterteam.ntua.gr/), which is jointly offered by the School of Electrical and Computer Engineering and the School of Mechanical Engineering.
...
Venue: [Multimedia Amphitheater, Library Building, NTUA Campus](https://www.google.com/maps/place/%CE%91%CE%BC%CF%86%CE%B9%CE%B8%CE%AD%CE%B1%CF%84%CF%81%CE%BF+%CE%A0%CE%BF%CE%BB%CF%85%CE%BC%CE%AD%CF%83%CF%89%CE%BD+%CE%95%CE%9C%CE%A0/@37.9781938,23.7821229,17z/data=!3m1!4b1!4m6!3m5!1s0x14a1bd578ca67c27:0x5e34ae42a3868103!8m2!3d37.9781938!4d23.7821229!16s/g/11fxcgdg7m?entry=ttu)

Remote Access: [Zoom Meeting](https://mit.zoom.us/meeting/register/tJwvceyvrTooG9FRbhK3REmKFNrwSAONlI6y)
...
To better prepare the event and ensure we have a seat for you, please RSVP using this [form](https://forms.gle/LNGmY5ZDUYNQbCbr7).
